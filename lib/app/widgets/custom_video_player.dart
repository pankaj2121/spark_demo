...
class CustomVideoPlayer extends StatefulWidget {
  ...
  const CustomVideoPlayer({super.key, required this.videoPath, required this.isCircular});
...
class _CustomVideoPlayerState extends State<CustomVideoPlayer> {
  ...
  Widget build(BuildContext context) {
    ...
    return widget.isCircular ? ClipOval(child: videoWidget,) : ClipRRect(borderRadius: BorderRadius.circular(10.r),child: videoWidget,);
  }
